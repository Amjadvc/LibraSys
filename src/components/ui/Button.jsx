...
const variants = {
  ...
  formbutton:
    'rounded-[8px] min-w-[154px] bg-primary-500 disabled:hover:bg-primary-500 hover:bg-primary-600 px-6 py-2 text-[16px] font-medium text-white transition-colors',
